...
#define RPiPico			// use RaspberryPi Pico
...
//		word SPITransferWord (u_int32 address, byte value, boolean debug);
		...
		void SetYUVLine  (byte channel, word x, word y, word length, byte *LineArray );   			// colour is single word
