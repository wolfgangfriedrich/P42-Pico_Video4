// Pico Video4 header file for 
// P42 Pico Video4 Demo 
...
// Last change: 2023/Sept/05

#ifndef P42Pico_Video4_h
#define P42Pico_Video4_h

#define PICO_VIDEO4_VERSION "V1.1"
#define PICO_VIDEO4_VER_DATE "18. July 2024 "
...
#define ON_DEBOUNCE_WAIT  200		// msec
#define OFF_DEBOUNCE_WAIT  200		// msec
...
#define CMD_MEM           'm'     // show memory map of single image s[0-8]
#define CMD_DELETE        'd'     // delete a single image memory section s[0-8]
#define CMD_HELP          '?'     // ? 
