// Sketch for P42 VGA Shield/Wing
// Memory test and FLASH write with character set, BoingBall Demo and a BMP Picture
// written by
// Wolfgang Friedrich
// Last change: 2020/Mar/21

// https://hackaday.io/project/170499-vga-shield-wing
// https://github.com/wolfgangfriedrich/P42VGA
...
const int MemSelectPin		= 24;
const int nHOLDPin			= 23;
const int nWPPin			= 20;
...
//	P42Display::Init()
	...
	Serial.begin(19200);
	Serial.println("");
	Serial.println(F("P42 VGA Shield Memory Test"));
...
// Find VS23S040
	...
	SPI.transfer( 0x9F );				// ReadDeviceID
